...
You can create video models that call the Google Generative AI API using the `.video()` factory method.
For more on video generation with the AI SDK see [experimental_generateVideo()](/docs/reference/ai-sdk-core/experimental-generate-video).

### Veo Models

[Veo](https://ai.google.dev/gemini-api/docs/models/veo-3.1-lite-generate-preview) models are dedicated video generation models.
...
| Model | Aspect Ratios |
| --- | --- |
| `veo-3.1-generate-preview` | 16:9, 9:16, 21:9, 4:3, 1:1 |
| `veo-3.1-lite-generate-preview` | 16:9, 9:16, 21:9, 4:3, 1:1 |

<Note>
  Veo models support image-to-video generation by passing an image in the `image` parameter.
</Note>
